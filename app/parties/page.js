  ...
  return (
    <main style={styles.main}>
      ...
      <div style={styles.filtres}>
        ...
        <button style={filtre === 'novices' ? styles.filtrActif : styles.filtre} onClick={() => setFiltre('novices')}>Accessible novices</button>
          ...
          <div key={partie.id} style={styles.carte}>
            ...
            <div style={styles.places}>
              <span style={partie.places_restantes > 0 ? styles.placesOk : styles.placesFull}>
                {partie.places_restantes > 0
                  ? `${partie.places_restantes} place(s) restante(s)`
                  : 'Complet'}
              </span>
            </div>
          </div>
